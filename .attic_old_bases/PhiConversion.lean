...
inverse-coordinate variable (`inv_re_bridge`, StemFactorization.lean), NOT the
...
weight of the open node: were it to close, `ASection.concentricity` would
be a theorem of the class outright.
