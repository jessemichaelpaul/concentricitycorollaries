...
% The web build (plasTeX) predefines \ifplastex = true; define it as false
% for the pdf build. Used by the auto-generated content to keep tikz-cd
% diagrams in the pdf while showing a placeholder on the web.
\newif\ifplastex
\plastexfalse
