...
\newlabel{eq:orbit-stabilizer}{{{OS}}{17}{The projective base, genuine section functor, and total category}{AMS.8}{}}
\newlabel{sec:detector}{{10}{19}{The concentricity theorem}{section.10}{}}
\newlabel{prop:weierstrass}{{10.1}{19}{Slice-regular Weierstrass factorization; the content of C3}{theorem.10.1}{}}
\newlabel{lem:residue-spheres}{{10.2}{19}{Residue-$\CC $ zeros are $6$-sphere components of $\mathcal H_1$}{theorem.10.2}{}}
\newlabel{lem:pi0-grothendieck}{{10.3}{19}{$\pi _0$ of a Grothendieck construction}{theorem.10.3}{}}
\newlabel{def:A-section}{{10.4}{20}{$A$-sections}{theorem.10.4}{}}
\newlabel{def:residue-subdiagram}{{10.5}{20}{The residue subdiagram and its inclusion}{theorem.10.5}{}}
\newlabel{lem:c-residue-transitive}{{10.6}{21}{Transitivity of the C-residue total}{theorem.10.6}{}}
\newlabel{eq:north-graph}{{{A}}{21}{The concentricity theorem}{AMS.9}{}}
\newlabel{eq:north-preimages}{{{P}}{21}{The concentricity theorem}{AMS.10}{}}
\newlabel{eq:north-face-squares}{{{S}}{22}{The concentricity theorem}{AMS.11}{}}
\newlabel{eq:north-boundary-readings}{{{B}}{23}{The concentricity theorem}{AMS.12}{}}
\newlabel{eq:north-input-readings}{{{I}}{23}{The concentricity theorem}{AMS.13}{}}
\newlabel{eq:north-relative-stabilizer}{{{R}}{23}{The concentricity theorem}{AMS.14}{}}
\newlabel{eq:north-fibre-arrow}{{{$\Phi $}}{24}{The concentricity theorem}{AMS.15}{}}
\newlabel{eq:north-witness-readings}{{{N}}{24}{The concentricity theorem}{AMS.16}{}}
\newlabel{eq:residue-total-base-arrow}{{{G}}{24}{The concentricity theorem}{AMS.17}{}}
\newlabel{thm:concentricity}{{10.7}{24}{Concentricity}{theorem.10.7}{}}
\newlabel{cor:nontrivial}{{10.8}{27}{Translation to the classical framework}{theorem.10.8}{}}
\newlabel{sec:verification}{{11}{27}{Corollaries}{section.11}{}}
\newlabel{cor:zeta-section}{{11.1}{27}{$\zetaO $ is an $A$-section}{theorem.11.1}{}}
\newlabel{cor:rh}{{11.2}{28}{Riemann Hypothesis}{theorem.11.2}{}}
\newlabel{rmk:image-span}{{11.3}{28}{The image span of a fully faithful inclusion}{theorem.11.3}{}}
\bibcite{AdF}{1}
\bibcite{AdFslice}{2}
\bibcite{Baez02}{3}
...
\bibcite{SeriesExp}{7}
\bibcite{GS07}{8}
\newlabel{rmk:thomason}{{11.4}{29}{Two alternative routes}{theorem.11.4}{}}
\bibcite{GSS13}{9}
\bibcite{GV}{10}
\bibcite{Hardy14}{11}
...
\par\medskip\textbf{Master revision.} {\ttfamily\small\seqsplit{30fd1bc9ed39d120fc0fe0343bbf820a0456492c55ee301f5cfcf4a4545faf84}}
\par\textbf{Lean-source revision.} {\ttfamily\small\seqsplit{bce3459cf809434e0b25d19e5685dedfe07ae0aa7db45d0cdf1dd05b3f7f75f5}}
\bigskip
...
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Receipt import.} \textcolor{KgtRed}{RECEIPT\_PRODUCER\_REJECTED: certificate failures: ASection.northState\_is\_residueActionState\_audit, ASection.residueActionState\_north\_input\_audit, ASection.residueActionTransport\_north\_input\_audit, ASection.northRelativeLoop\_maps\_audit, ASection.northComparison\_of\_parallelFaces\_audit, ASection.relativeActionSquare\_transport\_audit, ASection.residueTotal\_morphism\_of\_northComparison\_audit}
\end{tcolorbox}
\medskip
...
\par\textbf{Author's object.} \url{—}
\par\textbf{Object relation.} Object relation not checked
\par\textbf{Exact state.} Lean declaration accepted with sorryAx; authored-object anchor unratified
\par\smallskip\textbf{Lean command and literal axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
#print axioms zeta_criticalLine_zeros_infinite
'zeta_criticalLine_zeros_infinite' depends on axioms: [propext, sorryAx, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Receipt import.} \textcolor{KgtRed}{RECEIPT\_PRODUCER\_REJECTED: certificate failures: ASection.northState\_is\_residueActionState\_audit, ASection.residueActionState\_north\_input\_audit, ASection.residueActionTransport\_north\_input\_audit, ASection.northRelativeLoop\_maps\_audit, ASection.northComparison\_of\_parallelFaces\_audit, ASection.relativeActionSquare\_transport\_audit, ASection.residueTotal\_morphism\_of\_northComparison\_audit}
\end{tcolorbox}
...
$o_b:N\to b$. Every arrow $f:x\to y$ then has a residual north-stabilizer factor
\[
  r_f=o_y^{-1}f\,o_x,\qquad
  f=o_y r_f o_x^{-1},
\]
and it is the only one: the representatives $o_x,o_y$ are fixed, so
$f=o_y r o_x^{-1}$ determines $r=o_y^{-1}f o_x$ outright. Uniqueness of the
stabilizer part is therefore not an extra hypothesis but the invertibility of
the representatives, and every later appeal to it --- including at the two
boundary transports of the comparison in Lemma~\ref{lem:c-residue-transitive}
--- is this one line
\textup{(}\texttt{GreatCircle.stabilizerPart\_unique}\textup{)}.
Write $a_A$ for the positioning of the distinguished element over the base. It
assigns to each object $b$ the M\"obius element $a_A(b)$ carrying $D_A$ to the
frame at $b$, and to each arrow $f:x\to y$ the M\"obius element $a_A(f)$
carrying the frame at $x$ to the frame at $y$. Both are given by the orbit and
stabilizer factors just fixed:
\[
...
\]
Here $\operatorname{cayleyProjective}(-)$ denotes the multiplicative Cayley-projective homomorphism, and
$f\fatsemi g$ denotes composition in diagrammatic order: $f$ first, then $g$.
The fixed orbit representatives force $r_f$ uniquely; $r_{1_x}=1$ and
$r_{f\fatsemi g}=r_g r_f$. These identities, together with multiplicativity of $\operatorname{cayleyProjective}(-)$,
prove the identity and composition laws directly from the fixed representatives.

Equation \eqref{eq:orbit-stabilizer} is the orbit--stabilizer well-definedness of
every functor in this paper, and it is the only device used to obtain one.  Each
is built the same way: the distinguished element $D_A$, carried to every object
by the Cayley map along the fixed orbit representatives.  An object is positioned
by $a_A(b)=\operatorname{cayleyProjective}(o_b)D_A$; an arrow is positioned by $a_A(f)$, which is nothing but
its residual stabilizer factor $r_f$ conjugated between the frames at its two
ends.  Because $r_f$ is forced and $\operatorname{cayleyProjective}(-)$ is a homomorphism, the functor laws
are not separate obligations --- they are the two identities just displayed.
...
\]
written \texttt{AsectionActionDiagram\,A} in the Lean source.  Explicitly, on
objects and on arrows:
\begin{itemize}
\item \textbf{On objects.} A base object $b$ is sent to the groupoid of
  normalized A-section states positioned by its object frame $a_A(b)=\operatorname{cayleyProjective}(o_b)D_A$.
  An object of that groupoid is one constrained graph \eqref{eq:north-graph} ---
  a slice direction $I\in S^6$ and a normalized input coordinate $u$, together
  with the positioned coordinate $a_A(b)\mathbin{\cdot}(I,u)$ and its realized
  A-value.  An arrow of that groupoid is a single element $\gamma\in G_2$,
  acting on the slice direction and carrying the whole graph with it: the fibre
  is the action groupoid of $G_2$ on the states, and nothing else.
\item \textbf{On arrows.} A base arrow $f:x\to y$ is sent to transport by its
  arrow element $a_A(f)=a_A(y)\,\operatorname{cayleyProjective}(r_f)\,a_A(x)^{-1}$ of
  \eqref{eq:orbit-stabilizer}.  On a state this moves the input coordinate by
  the input leg $\operatorname{cayleyProjective}(r_f)$ and the positioned coordinate by the positioned leg,
  the two horizontal legs of the square whose verticals are the frames at the
  two ends; on an arrow it is the identity on $\gamma$, since $G_2$ commutes
  past the positioning.  Functoriality is the two forced identities
  $r_{1_x}=1$ and $r_{f\fatsemi g}=r_g r_f$ carried by the homomorphism $\operatorname{cayleyProjective}(-)$,
  and is therefore not a separate obligation.
\end{itemize}
...
'ASection.residueActionState_mem' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
...
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Lean declaration.} \url{ASection.ambientTotalCategory}
\par\textbf{Author's object.} \url{—}
\par\textbf{Object relation.} Object relation not checked
\par\textbf{Exact state.} Lean declaration accepted; approved axiom surface; authored-object anchor unratified
\par\smallskip\textbf{Lean command and literal axiom print.}
...
'ASection.ambientTotalCategory' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Lean declaration.} \url{ASection.ambientTotalGroupoid}
\par\textbf{Author's object.} \url{—}
\par\textbf{Object relation.} Object relation not checked
\par\textbf{Exact state.} Lean declaration accepted; approved axiom surface; authored-object anchor unratified
\par\smallskip\textbf{Lean command and literal axiom print.}
...
'ASection.ambientTotalGroupoid' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Lean declaration.} \url{grothendieckGrpdGroupoid}
\par\textbf{Author's object.} \url{—}
\par\textbf{Object relation.} Object relation not checked
\par\textbf{Exact state.} Lean declaration accepted; approved axiom surface; authored-object anchor unratified
\par\smallskip\textbf{Lean command and literal axiom print.}
...
'grothendieckGrpdGroupoid' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
...
Explicitly, on objects and on arrows:
\begin{itemize}
\item \textbf{On objects.} A base object $X$ is sent to the full subgroupoid of
  $\mathcal A_A(X)$ on the witnessed states: those $x$ for which there are a
  north residue state $x_N$ and a base arrow $g:N\to X$ with
  $\mathcal A_A(g)(x_N)=x$.  The witness travels with the object.
\item \textbf{On arrows.} A base arrow $f:X\to Y$ is sent to the restriction of
  the ambient transport $\mathcal A_A(f)$.  It lands, because a witnessed state stays
  witnessed with the \emph{same} north state and the composite witness
  $g\fatsemi f$ --- that is the whole content, and it is functoriality of
  $\mathcal A_A$ and nothing further.
\end{itemize}
...
'ASection.AsectionCResidueInclusionTotal' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
...
'ASection.AsectionCResidueInclusionTotal_full' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
...
'ASection.AsectionCResidueInclusionTotal_faithful' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Lean declaration.} \url{ASection.residueTotalCategory}
\par\textbf{Author's object.} \url{—}
\par\textbf{Object relation.} Object relation not checked
\par\textbf{Exact state.} Lean declaration accepted; approved axiom surface; authored-object anchor unratified
\par\smallskip\textbf{Lean command and literal axiom print.}
...
'ASection.residueTotalCategory' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Lean declaration.} \url{ASection.residueTotalGroupoid}
\par\textbf{Author's object.} \url{—}
\par\textbf{Object relation.} Object relation not checked
\par\textbf{Exact state.} Lean declaration accepted; approved axiom surface; authored-object anchor unratified
\par\smallskip\textbf{Lean command and literal axiom print.}
...
'ASection.residueTotalGroupoid' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Receipt import.} \textcolor{KgtRed}{RECEIPT\_PRODUCER\_REJECTED: certificate failures: ASection.northState\_is\_residueActionState\_audit, ASection.residueActionState\_north\_input\_audit, ASection.residueActionTransport\_north\_input\_audit, ASection.northRelativeLoop\_maps\_audit, ASection.northComparison\_of\_parallelFaces\_audit, ASection.relativeActionSquare\_transport\_audit, ASection.residueTotal\_morphism\_of\_northComparison\_audit}
\end{tcolorbox}
...
'ASection.sweepTransitive_on_residueSystem' depends on axioms: [propext, sorryAx, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
...
'ASection.northRelativeLoop_maps' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
...
'ASection.northComparison_of_parallelFaces' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Receipt import.} \textcolor{KgtRed}{RECEIPT\_PRODUCER\_REJECTED: certificate failures: ASection.northState\_is\_residueActionState\_audit, ASection.residueActionState\_north\_input\_audit, ASection.residueActionTransport\_north\_input\_audit, ASection.northRelativeLoop\_maps\_audit, ASection.northComparison\_of\_parallelFaces\_audit, ASection.relativeActionSquare\_transport\_audit, ASection.residueTotal\_morphism\_of\_northComparison\_audit}
\end{tcolorbox}
...
'ASection.residueTotal_isConnected' depends on axioms: [propext, sorryAx, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
...
'ASection.residueTotal_pi0_singleton' depends on axioms: [propext, sorryAx, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Lean declaration.} \url{ASection.transportLevel}
\par\textbf{Author's object.} \url{—}
...
'ASection.nontrivial_one_centre' depends on axioms: [propext, sorryAx, Classical.choice, Quot.sound]
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Receipt import.} \textcolor{KgtRed}{RECEIPT\_PRODUCER\_REJECTED: certificate failures: ASection.northState\_is\_residueActionState\_audit, ASection.residueActionState\_north\_input\_audit, ASection.residueActionTransport\_north\_input\_audit, ASection.northRelativeLoop\_maps\_audit, ASection.northComparison\_of\_parallelFaces\_audit, ASection.relativeActionSquare\_transport\_audit, ASection.residueTotal\_morphism\_of\_northComparison\_audit}
\end{tcolorbox}
