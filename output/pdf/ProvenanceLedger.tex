...
\par\medskip\textbf{Master revision.} {\ttfamily\small\seqsplit{c023ddc2e00c24cc344839b150b23b11fa8478949e78666fd4784a28a894f33a}}
\par\textbf{Lean-source revision.} {\ttfamily\small\seqsplit{ee9eafeb23721f66d80cf5ad488e7fde77be068c85a92c466459e4b3952de6e5}}
\bigskip
...
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Supporting inference and bindings.} No local receipt is registered for this clause.
\end{tcolorbox}
\medskip
...
\par\textbf{Literal Lean axiom print.} Not available because the axiom query was not reached.
\medskip\hrule\medskip
\textbf{Receipt classification.} INFERENCE\_CERTIFIED\_AUTHOR\_BOUND\_LEAN\_PENDING
\par\smallskip\textbf{Certified inference.} \url{ASection.northState_is_residueActionState_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.northState_is_residueActionState_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\smallskip\textbf{Certified inference.} \url{ASection.residueActionState_north_input_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.residueActionState_north_input_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\smallskip\textbf{Certified inference.} \url{ASection.residueActionTransport_north_input_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.residueActionTransport_north_input_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\smallskip\textbf{Certified inference.} \url{ASection.northRelativeLoop_stabilizer_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.northRelativeLoop_stabilizer_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\smallskip\textbf{Certified inference.} \url{ASection.northRelativeLoop_maps_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.northRelativeLoop_maps_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\smallskip\textbf{Certified inference.} \url{ASection.northComparison_of_parallelFaces_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.northComparison_of_parallelFaces_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\smallskip\textbf{Certified inference.} \url{ASection.relativeActionSquare_transport_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.relativeActionSquare_transport_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\smallskip\textbf{Certified inference.} \url{ASection.residueTotal_morphism_of_northComparison_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.residueTotal_morphism_of_northComparison_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\textbf{Authored binding.} \url{seat1.kE}: AUTHOR\_BOUND\_LEAN\_PENDING
\par\textbf{Authored binding.} \url{seat1.kW}: AUTHOR\_BOUND\_LEAN\_PENDING
\par\textbf{Authored binding.} \url{seat1.uStar}: AUTHOR\_BOUND\_LEAN\_PENDING
\par\textbf{Authored binding.} \url{seat1.hE}: AUTHOR\_BOUND\_LEAN\_PENDING
\par\textbf{Authored binding.} \url{seat1.hW}: AUTHOR\_BOUND\_LEAN\_PENDING
\par\textbf{Production seat.} \url{ASection.sweepTransitive_on_residueSystem}: OPEN\_SEAT
\end{tcolorbox}
\medskip
...
\medskip\hrule\medskip
\textbf{Receipt classification.} INFERENCE\_CERTIFIED\_AUTHOR\_BOUND\_LEAN\_PENDING
\par\smallskip\textbf{Certified inference.} \url{ASection.residueTotal_isConnected_of_transitive_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.residueTotal_isConnected_of_transitive_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\smallskip\textbf{Certified inference.} \url{ASection.residueTotal_pi0_singleton_of_connected_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.residueTotal_pi0_singleton_of_connected_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\textbf{Authored binding.} \url{seat2.transportLevelCollapse}: AUTHOR\_BOUND\_LEAN\_PENDING
\par\textbf{Production seat.} \url{ASection.concentricity}: OPEN\_SEAT
\end{tcolorbox}
\medskip
...
\par\textbf{Literal Lean axiom print.} Not available because the axiom query was not reached.
\medskip\hrule\medskip
\textbf{Receipt classification.} INFERENCE\_CERTIFIED
\par\smallskip\textbf{Certified inference.} \url{ASection.nontrivial_one_centre_of_concentricity_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'ASection.nontrivial_one_centre_of_concentricity_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\end{tcolorbox}
\medskip
...
\medskip\hrule\medskip
\textbf{Receipt classification.} INFERENCE\_CERTIFIED
\par\smallskip\textbf{Certified inference.} \url{zeta_riemannHypothesis_of_concentricity_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'zeta_riemannHypothesis_of_concentricity_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\par\smallskip\textbf{Certified inference.} \url{zeta_criticalLine_zeros_infinite_of_RH_audit}
\par\textbf{Status.} INFERENCE\_CERTIFIED
\par\textbf{Literal Lean axiom print.}
\begin{Verbatim}[breaklines=true,breakanywhere=true,fontsize=\small]
'zeta_criticalLine_zeros_infinite_of_RH_audit' depends on axioms: [propext, Classical.choice, Quot.sound]
\end{Verbatim}
\end{tcolorbox}
\medskip
\end{document}
