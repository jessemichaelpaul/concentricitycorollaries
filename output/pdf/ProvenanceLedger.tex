...
\par\medskip\textbf{Master revision.} {\ttfamily\small\seqsplit{fb6b67512a322512cffbda4ca6e993b015fb53ea325a9b387e5a518a5e00ffef}}
\par\textbf{Lean-source revision.} {\ttfamily\small\seqsplit{89518144a67d39a37ad326dd32458e3b68419c48a9b6d0c71dc3393a365cab28}}
\bigskip
...
\end{Verbatim}
\medskip\hrule\medskip
\textbf{Receipt import.} \textcolor{KgtRed}{RECEIPT\_PRODUCER\_REJECTED: certificate failures: ASection.northRelativeLoop\_maps\_audit, ASection.relativeActionSquare\_transport\_audit}
\end{tcolorbox}
\medskip
...
\]
Here $C(-)$ denotes the multiplicative Cayley-projective homomorphism, and
$f\mathbin{;}g$ denotes composition in diagrammatic order: $f$ first, then $g$.
The fixed orbit representatives force $r_f$ uniquely; $r_{1_x}=1$ and
$r_{f\mathbin{;}g}=r_g r_f$. These identities, together with multiplicativity of $C(-)$,
...
by $a_A(b)=C(o_b)D_A$; an arrow is positioned by $a_A(f)$, which is nothing but
its residual stabilizer factor $r_f$ conjugated between the frames at its two
ends.  Because $r_f$ is forced and $C(-)$ is a homomorphism, the functor laws
...
\end{tikzcd}
\qquad
\operatorname{Out}_A=\operatorname{In}_A\mathbin{;}A_{\OO}.
\]
This equality is
