...
$\pi_0$ reads off their component.\footnote{Remark~\ref{rmk:pi0-split} sketches an
alternative, finality-based computation of $\pi_0$; it is expository and not used here.}
...
(\cite[Def.~4.7]{GPVwind}) --- so their lifts to the logarithm manifold, when they
