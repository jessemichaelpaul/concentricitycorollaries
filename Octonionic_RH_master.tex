...
It is a functor of action groupoids at both ends. Its source
...
to $y$. Each value is an action groupoid too, and the element acting there is
the distinguished one, $D_A$.

On a base object $b$, the value $\mathcal A_A(b)$ is the groupoid of normalized
