...
and a nonempty action groupoid whose action reaches
every member is connected --- this is the connectedness instance of the Lean library's
\texttt{ActionCategory} itself, transported along $\iota_A$'s proper inclusion:
