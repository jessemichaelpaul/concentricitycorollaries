...
\]
This is the precise passage from the two functorial runs to their
...
runs of the distinguished action:
\[
\begin{aligned}
...
$k_{EN,i}=o_Nr_i o_0^{-1}$: the first run inverted, followed by the second,
cancels the common $0$-frame $o_0$, and $o_N=1$ at the north
